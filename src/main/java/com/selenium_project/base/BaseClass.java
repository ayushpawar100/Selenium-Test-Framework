...
import com.selenium_project.utilities.LoggerManager;
...
public class BaseClass {
	...
	public synchronized void setup() {
		...
		/*
		 * //Initialize the actionDriver only once if(actionDriver==null) { actionDriver
	...
	public synchronized void launchBrowser() {
		...
		if (browser.equalsIgnoreCase("chrome")) {
			...
			options.addArguments("--no-sanbox"); // Required for some CI environments like Jenkins
